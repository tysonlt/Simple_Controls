 ...
 * Default is 4.
 */ 
void Potentiometer::setSmoothingFactor(byte smoothingFactor) {
 ...
 */ 
int Potentiometer::_smoothValue(int raw) {
    ...
    if (_smoothingFactor <= 0) {
        ...
        */
        ...
        v += (raw - v) / _smoothingFactor; //compiler should optimise this to a bitshift
